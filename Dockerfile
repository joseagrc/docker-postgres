...
LABEL org.opencontainers.image.authors="Jose Arturo Garcia <jgarcia@solutema.com>"
LABEL org.opencontainers.image.vendor="Solutema, SRL"
LABEL org.opencontainers.image.description="PostgreSQL multi-architecture container image"
LABEL org.opencontainers.image.title="Dockerized PostgreSQL Image"
